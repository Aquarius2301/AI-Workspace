...
public class User
{
    ...
    /// <summary>
    /// Gets or sets the ID of the picture used as the user's avatar.
    /// </summary>
    public Guid? AvatarPictureId { get; set; }

    /// <summary>
    /// Gets or sets the picture used as the user's avatar.
    /// </summary>
    public Picture? AvatarPicture { get; set; }
