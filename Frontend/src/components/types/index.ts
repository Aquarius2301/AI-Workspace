...
export const aiWorkspaceTheme = {
  // CONFIG CHO GIAO DIỆN SÁNG (LIGHT MODE)
  light: {
  ...
  // CONFIG CHO GIAO DIỆN TỐI (DARK MODE)
  dark: {
...
// 🌟 CUSTOM STYLE CHO NÚT AI MAGIC (Dùng CSS inline bằng TS)
// Vì AntD Token không hỗ trợ trực tiếp gradient cho Button dạng 'primary'
export const aiMagicButtonStyle: React.CSSProperties = {
